        ...
        <div>
          <div className="form-control">
            <div className="input-group">
              <input type="text" value={address} placeholder="Search Address…" className="input input-bordered w-max" onChange={inputHandler}/>
          ...
          <div className="overflow-x-auto">
            <table className="table w-full">
              ...
              <tbody>
                ...
                <tr>
                  <td>PROFIT</td>
                  <td className="font-black">{ethers.utils.formatEther(s)}</td>
                </tr>
              </tbody>
            </table>
          </div>
